...
const config = {
  ...
  output: {
    path: path.resolve(__dirname, '../../dist/honor'),
    filename: process.env.NODE_ENV === 'production' ? 'honor.bundle.[hash].js' : 'honor.bundle.js',
  ...
  devServer: {
    contentBase: path.join(__dirname, '../../dist/honor'),
    compress: true,
